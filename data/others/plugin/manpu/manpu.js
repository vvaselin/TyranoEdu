...
(function(){
    ...
    if (typeof TEMPURA.tag.manpu !== "undefined") {
        console.log("manpuプラグインはすでに読み込まれています。");
        return;
    }
    ...
    // タグを定義
    //#[manpu_reset]
    TEMPURA.tag["manpu_reset"] = {
        start: function () {
            $(".tempura-manpu").remove();
    ...
    TEMPURA.tag["manpu"] = {
        ...
        start: function (pm) {
            ...
            // 画像エレメント追加
            manpu.element = $("<img />").addClass("tempura-manpu");
