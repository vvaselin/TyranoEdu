...
[chara_untilt name="mocha" time=300]
...
#&tf.you
真面目な解説始まっちゃった……。[l][r]
クラス……？ まだ習ってない知識なんだけど。[p]

[chara_mod name="mocha" face="hokkori" time=200]
[manpu layer="0" name="mocha" type=waiwai]
[yureru_x chara=mocha left=300 time=200]
#mocha
ごめん、……つい癖で。[p]
...
[chara_mod name="mocha" face="surprise" time=200]
[chara_tilt name="mocha" deg=2 time=300 origin="50% 100%"]
#mocha
雑談……？[p]
