...
#
配列、文字列、構造体。[p]
今日の範囲は、これまでよりも少しだけ情報量が多かった。[l][r]
...
#&tf.you
最初から全部知るんじゃなくて、少しずつ覚えていくというか。[l][r]
...
#&tf.you
うん。[l][r]
例えば、モカって休み時間は何してるの？[p]

[chara_mod name="mocha" face="komari" time=200]
#mocha
えっと……本を読んだり、次の課題を見たり……。[l][r]
あと、購買のカフェオレを飲んだり、かな。[p]
