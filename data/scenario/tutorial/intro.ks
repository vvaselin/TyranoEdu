...
[rect_show name="hint" x=100 y=210 width=160 height=40 color="#ff4500" border=4 bg="rgb(0,0,0,0)" radius=5]
[chara_mod name="mocha" face="thinking" time=200]
ヒントが読みたいときはヒント開いたり、[l][r]
[rect_show name="doc" x=860 y=50 width=50 height=80 color="#ff4500" border=4 bg="rgb(0,0,0,0)" radius=5]
